...
DEFAULT_OUTPUT = Path("raw/raw_blockchain_metrics.csv")
CHARTS = {
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fetch daily Bitcoin on-chain metrics from Blockchain.com."
    )
...
def build_rows(start_date: str) -> list[dict[str, object]]:
    ...
    for chart_name, column_name in CHARTS.items():
...
def main() -> None:
    ...
    if not rows:
        raise RuntimeError("No Blockchain.com rows were returned.")
